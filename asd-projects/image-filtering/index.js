...
function decreasedBlue(array){ // this function takes 50 from the blue value
    array[BLUE] = keepInBounds (array[BLUE] -= 50);
}

function increasedGreenByBlue(array){ // this function increases the green value by the blue value 
